...
import data from '../Candlesticks2/state.js';
import ChapterContainer from '../Candlesticks2/ChapterContainer';

export default class Candlesticks2 extends Component{
