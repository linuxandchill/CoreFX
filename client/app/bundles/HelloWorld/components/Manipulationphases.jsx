...
import data from '../ManipulationPhases/state.js';
import ChapterContainer from '../ManipulationPhases/ChapterContainer';

export default class Manipulationphases extends Component{
